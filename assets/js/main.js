...
function loadSummary(data) {
  ...
  console.log(data.Global.Date);
//  console.log(formatDate(data.Global.Date));
  active.innerText = new Date(data.Global.Date);
...
console.log(`https://api.covid19api.com/country/${country}?from=${startDate.toISOString()}&to=${endDate.toISOString()}`)
    fetch(
